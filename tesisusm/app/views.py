...
class Dashboard(TemplateView):
	...
	def get_context_data (self, **kwargs):
		...
		context['sesion'] = Usuario.objects.all()
...
class EstadisticasVentas(TemplateView):
	...
	def post (self, request, *args, **kwargs):
		...
		return render_to_response(
			self.template_name, 
			{'utilidad': utilidad, 'sesion': sesion, 'now': now}, 
			context_instance=RequestContext(request))

#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#
#PROYECCION
class Proyecciones(FormView):
	template_name = 'estadistica/proyeccion.html'
	form_class = ProyeccionForm
	success_url = reverse_lazy('proyecciones_ventas')

	def form_valid (self, form):
		proyeccion = form.save()
		return super(Proyecciones, self).form_valid(form)

	def get_context_data (self, **kwargs):
		context = super(Proyecciones, self).get_context_data(**kwargs)
		context['sesion'] = Usuario.objects.all()
		context['now'] = datetime.datetime.now()
		return context
...
#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#
#ESTADISTICA
class ProyeccionesVentas(TemplateView):
	template_name = 'estadistica/proyeccion_venta.html'

	def get_context_data (self, **kwargs):
		context = super(ProyeccionesVentas, self).get_context_data(**kwargs)
		context['utilidad'] = Proyeccion_Venta.objects.all()
		context['sesion'] = Usuario.objects.all()
		context['now'] = datetime.datetime.now()
		return context
