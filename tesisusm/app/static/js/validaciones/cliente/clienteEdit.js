$(document).ready(function(){
	...
	var regexName = /^([A-Za-zÁáÉéÍíÓóÚúÜüÑñ'"#@-_,\d\s\.\/]{2,50})$/;
	...
	$('#id_telefono_1').focus(function(){
		$(this).keyup(function(){
			...
			if ($(this).val().length >= 1 && $(this).val().match(regexPhone) && ($(this).val() !== $('#id_telefono_2').val()) && ($(this).val() !== $('#id_fax').val())) {
	...
	$('#id_fax').focus(function(){
		$(this).keyup(function(){
			...
			if ($(this).val().length >= 1 && $(this).val().match(regexFax) && ($(this).val() !== $('#id_telefono_1').val()) && ($(this).val() !== $('#id_telefono_2').val())) {
