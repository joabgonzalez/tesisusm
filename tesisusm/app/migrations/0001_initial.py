    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cargo', models.ForeignKey(default=None, blank=True, to='app.Cargo', null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Inventario',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.ForeignKey(default=None, blank=True, to='app.Rol_Usuario', null=True)),
        ...
        migrations.AddField(
            model_name='empleado',
            name='tipo_empleado',
            field=models.ForeignKey(default=None, blank=True, to='app.Tipo_Empleado', null=True),
        ),
    ]
