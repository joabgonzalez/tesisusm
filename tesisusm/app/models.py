...
class Usuario(models.Model):
	...
	rol = models.ForeignKey(Rol_Usuario, null=True, blank=True, default=2) #REQUERIDO
...
class Cliente(models.Model):
	...
	rif = models.CharField(max_length=12, unique=True) #REQUERIDO
...
class Proyeccion_Historico(models.Model):
	id_proyeccion_historico = models.AutoField(primary_key=True)
...
class Proyeccion_Venta(models.Model):
	id_utilidad_mensual = models.AutoField(primary_key=True)
	ano = models.IntegerField(unique=True) #REQUERIDO
	ene = models.IntegerField(null=True, blank=True)
	feb = models.IntegerField(null=True, blank=True)
