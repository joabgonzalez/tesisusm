...
class UserForm(UserCreationForm):
	...
	password1 = forms.CharField(
		...
		widget=forms.PasswordInput(attrs={
			...
			'data-toggle': 'tooltip', 
			'data-placement': 'top', 
			'title': 'Debe contener entre 6 y 20 caracteres con al menos una mayúscula, una minúscula y un número'}),
	)
...
class PerfilForm(ModelForm):
	class Meta:
		...
		widgets = {
				...
				'correo': forms.TextInput(attrs={
					'class': 'form-control', 
					'placeholder': 'Correo electrónico del usuario. Ejm: correo@picnikki.com',
					'autocomplete': 'off',
					'data-toggle': 'tooltip', 
					'data-placement': 'top', 
					'title': 'Debe ser una dirección de correo electrónico válida',
	...
	class Meta:
		...
		widgets = {
				'rif': forms.TextInput(attrs={
					'class': 'form-control', 
					'placeholder': 'Registro único de información fiscal del cliente. Ejm: J-12345678-9',
					'autocomplete': 'off',
					'data-toggle': 'tooltip', 
					'data-placement': 'top', 
					'title': 'Debe ingresar un formato de RIF válido, solo admite personas jurídcas (J), gubernamentales (G), venezolanos (V) y extranjeros (E)',
					}),
				'cliente': forms.TextInput(attrs={
					'class': 'form-control',
					'placeholder': 'Razón social del cliente. Ejm: Picnikki y Asociados C.A.',
					'autocomplete': 'off',
					'data-toggle': 'tooltip', 
					'data-placement': 'top', 
				...
				'telefono_1': forms.TextInput(attrs={
					...
					'data-toggle': 'tooltip', 
					'data-placement': 'top', 
					'title': 'Solo permite ingresar dígitos, no puede ser igual al teléfono secundario',
					}),
				'telefono_2': forms.TextInput(attrs={
					...
					'data-toggle': 'tooltip', 
					'data-placement': 'top', 
					'title': 'Solo permite ingresar números, no puede ser igual a nungún otro número de teléfono suministrado en este formulario',
					}),
				'fax': forms.TextInput(attrs={
					...
					'data-toggle': 'tooltip', 
					'data-placement': 'top', 
					'title': 'Solo permite ingresar números, no puede ser igual al teléfono principal',
					}),
				'correo': forms.TextInput(attrs={
					'class': 'form-control', 
					'placeholder': 'Correo electrónico del cliente. Ejm: correo@picknikki.com',
					'autocomplete': 'off',
					'data-toggle': 'tooltip', 
					'data-placement': 'top', 
					'title': 'Debe ser una dirección de correo electrónico válida',
	...
	class Meta:
		...
		widgets = {
				...
				'precio_unitario': forms.TextInput(attrs={
					...
					'data-toggle': 'tooltip', 
					'data-placement': 'top', 
					'title': 'Solo permite ingresar valores numéricos y punto (.) para valores decimales. Solo admite dos decimales',
					}),
		}
		labels = {
				'codigo': ("* Código"),
	...
	class Meta:
		...
		widgets = {
				...
				'cantidad_producto': forms.TextInput(attrs={
					...
					'data-toggle': 'tooltip', 
					'data-placement': 'top', 
					'title': 'Solo permite ingresar dígitos',
					}),
		}
		labels = {
...
class ProyeccionForm(ModelForm):
	class Meta:
		model = Proyeccion_Historico
		exclude = ('fecha',)
		widgets = {
				'ano': forms.TextInput(attrs={
					'class': 'form-control', 
					'placeholder': 'Ingrese año. Ejm: 2015',
					'autocomplete': 'off',
					'maxlength': '4',
					'data-toggle': 'tooltip', 
					'data-placement': 'top', 
					'title': 'Solo permite ingresar dígitos. Los únicos años permitidos son: 2015, 2016, 2017, 2018, 2019',
					}),	
		}
		labels = {
				'ano': (""),
	...
	class Meta:
		...
		widgets = {
				...
				'telefono_local': forms.TextInput(attrs={
					...
					'data-toggle': 'tooltip', 
					'data-placement': 'top', 
					'title': 'Solo permite ingresar dígitos, no puede ser igual a nungún otro número de teléfono suministrado en este formulario',
					}),
